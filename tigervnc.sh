...
fileUrl="http://tigervnc.bphinz.com/nightly/xc/x86_64/tigervnc-1.13.80-20230209git1e3484f2.x86_64.tar.gz"
fileName="tigervnc-1.13.80-20230209git1e3484f2.x86_64.tar.gz"
