...
fileUrl="http://tigervnc.bphinz.com/nightly/xc/x86_64/tigervnc-1.12.80-20221027git7c288cfc.x86_64.tar.gz"
fileName="tigervnc-1.12.80-20221027git7c288cfc.x86_64.tar.gz"
