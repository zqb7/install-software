...
fileUrl="http://tigervnc.bphinz.com/nightly/xc/x86_64/tigervnc-1.12.80-20211126git0c5a2b2e.x86_64.tar.gz"
fileName="tigervnc-1.12.80-20211126git0c5a2b2e.x86_64.tar.gz"
