...
fileUrl="http://tigervnc.bphinz.com/nightly/xc/x86_64/tigervnc-1.13.80-20240315git90e9db2d.x86_64.tar.gz"
fileName="tigervnc-1.13.80-20240315git90e9db2d.x86_64.tar.gz"
