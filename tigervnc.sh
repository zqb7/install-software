...
fileUrl="http://tigervnc.bphinz.com/nightly/xc/x86_64/tigervnc-1.13.80-20230601git57cdcedf.x86_64.tar.gz"
fileName="tigervnc-1.13.80-20230601git57cdcedf.x86_64.tar.gz"
