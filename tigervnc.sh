...
fileUrl="http://tigervnc.bphinz.com/nightly/xc/x86_64/tigervnc-1.12.80-20211014git7fe85cd4.x86_64.tar.gz"
fileName="tigervnc-1.12.80-20211014git7fe85cd4.x86_64.tar.gz"
